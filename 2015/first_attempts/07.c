...
/*
 * This code works with the example data, but doesn't work with the actual data, because
 * it only works with "perfectly formatted data", which is the case for the test but it is
 * no good with the actual data file.
 */
